  ...
  return (
    <section className="flex flex-col items-center px-6 py-12 lg:px-20 lg:py-20 bg-gradient-to-b from-blue-50 via-white to-blue-50 text-gray-800 space-y-10 lg:space-y-20"> 
      ...
      <div className="grid gap-8 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 w-full max-w-6xl">
        {/* Service Card: Stroke Rehabilitation */}
        <div className="bg-white rounded-lg shadow-lg p-6 hover:scale-105 transform transition-all duration-300 ease-in-out" key="stroke-rehabilitation">
        ...
        {/* Service Card: Back, Neck, and Spine Pain */}
        <div className="bg-white rounded-lg shadow-lg p-6 hover:scale-105 transform transition-all duration-300 ease-in-out" key="back-pain">
        ...
        {/* Service Card: Sports Injuries */}
        <div className="bg-white rounded-lg shadow-lg p-6 hover:scale-105 transform transition-all duration-300 ease-in-out" key="sports-injury">
        ...
        {/* Service Card: Post-Surgical Rehabilitation */}
        <div className="bg-white rounded-lg shadow-lg p-6 hover:scale-105 transform transition-all duration-300 ease-in-out" key="post-surgical-rehabilitation">
        ...
        {/* Service Card: Arthritis Management */}
        <div className="bg-white rounded-lg shadow-lg p-6 hover:scale-105 transform transition-all duration-300 ease-in-out" key="arthritis-management">
        ...
        {/* Service Card: Neurological Conditions */}
        <div className="bg-white rounded-lg shadow-lg p-6 hover:scale-105 transform transition-all duration-300 ease-in-out" key="neurological-conditions">
        ...
        {/* Service Card: Chronic Pain Management */}
        <div className="bg-white rounded-lg shadow-lg p-6 hover:scale-105 transform transition-all duration-300 ease-in-out" key="chronic-pain-management">
