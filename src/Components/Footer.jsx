...
const Footer = () => {
  return (
    <div className='flex flex-col md:flex-row items-start justify-between bg-secondary text-white px-4 md:px-8 lg:px-16 py-6 gap-6'>
      ...
      {/* Address Section */}
      <div className='md:w-1/4 flex flex-col mt-10'>
